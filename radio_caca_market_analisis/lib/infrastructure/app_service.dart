...
class AppService {
  ...
  static void addTransient<T>(ServiceFactoryFunc<T> func) {
    _factories[T] = _AppServiceFactory<T>(_AppServiceFactoryType.transient,
        factoryFunc: func);
  }

  /// Register singleton instance.
  static void addSingleton<T>(T instance) {
    _factories[T] = _AppServiceFactory<T>(_AppServiceFactoryType.singleton,
        instance: instance);
  }

  /// Register singleton with  factory method.
  static void addSingletonFactory<T>(ServiceFactoryFunc<T> func) {
    _factories[T] = _AppServiceFactory<T>(
        _AppServiceFactoryType.singletonFactory,
        factoryFunc: func);
  }
