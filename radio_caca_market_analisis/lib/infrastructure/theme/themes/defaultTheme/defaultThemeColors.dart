...
class DefaultThemeColors extends IAppColors {
  ...
  @override
  Color? get accent => const Color(0xffE5E8E8);
  ...
  ///rgb 255 255 255
  Color? get canvasAccent => const Color(0xffE5E8E8);

  @override

  ///rgb 144 142 151
  Color? get canvasPrimary => const Color(0xff4E545C);

  @override

  //rgb 244, 244, 245
  Color? get canvasPrimaryPale => const Color(0xff8D9797);
